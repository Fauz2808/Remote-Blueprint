const sections = [
  ...
  ['Data yang disimpan', 'Kami menyimpan email, purchase reference dari Lynk.id, status akses produk, dan progres action yang kamu selesaikan. Hasil Readiness Scanner dan Job Fit Checker tersimpan lokal di perangkatmu kecuali kamu login dan menyimpannya ke akun. Kami tidak menyimpan deskripsi job lengkap dan tidak meminta nomor telepon.'],
